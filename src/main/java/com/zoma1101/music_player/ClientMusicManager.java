...
public class ClientMusicManager {
    ...
    public static void onClientTick(ClientTickEvent.Post event) {
        ...
        if (player != null && mc.level != null && player.tickCount % CHECK_INTERVAL_TICKS == 0) { // mc.level != null
                                                                                                  // チェックを追加
    ...
    private static void playMusicByKey(String soundEventKey) {
        ...
        try {
            ...
            if (currentMusicInstance != null) {
                if (currentMusicInstance instanceof com.zoma1101.music_player.sound.FadingSoundInstance fadingInstance) {
                    fadingInstance.startFadeOut();
                } else {
